...
from electrum_xvg.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum_xvg import bitcoin
from electrum_xvg.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        import electrum_xvg
        try:
            uri = electrum_xvg.util.parse_URI(text, self.app.on_pr)
        except:
    ...
    def do_save(self):
        ...
        from electrum_xvg.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_xvg.util import create_URI
