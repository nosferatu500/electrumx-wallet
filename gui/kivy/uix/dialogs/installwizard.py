...
Factory.register('CreateRestoreDialog',
                 module='electrum_xvg_gui.kivy.uix.dialogs.create_restore')
...
class InstallWizard(Widget):
    ...
    def restore_seed_dialog(self, wallet):
        ...
        t = 'standard'
        if t == 'standard':
            from electrum_xvg_gui.kivy.uix.dialogs.create_restore import\
                RestoreSeedDialog
            RestoreSeedDialog(
    ...
    def show_seed(self, wallet=None, instance=None, password=None,
        ...
        from electrum_xvg_gui.kivy.uix.dialogs.create_restore import InitSeedDialog
    ...
    def password_dialog(self, wallet=None, instance=None, mode='create',
        ...
        from electrum_xvg_gui.kivy.uix.dialogs.create_restore import ChangePasswordDialog
