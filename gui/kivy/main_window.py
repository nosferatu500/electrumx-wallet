...
from electrum_xvg_gui.kivy.uix.drawer import Drawer
...
Factory.register('ELTextInput', module='electrum_xvg_gui.kivy.uix.screens')
...
class ElectrumWindow(App):
    ...
    def init_ui(self):
        ...
        Factory.register('TabbedCarousel',
                         module='electrum_xvg_gui.kivy.uix.screens')
        Factory.register('ScreenDashboard',
                         module='electrum_xvg_gui.kivy.uix.screens')
        Factory.register('EffectWidget',
                         module='electrum_xvg_gui.kivy.uix.effectwidget')
    ...
    def format_amount(self, x, is_diff=False, whitespaces=False):
        ...
        if not format_satoshis:
            from electrum_xvg.wallet import format_satoshis
    ...
    def update_wallet(self, *dt):
        ...
        if not self.exchanger:
            from electrum_xvg_gui.kivy.plugins.exchange_rate import Exchanger
