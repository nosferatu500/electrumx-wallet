...
import electrum_xvg
from electrum_xvg.bitcoin import TYPE_ADDRESS
from electrum_xvg import WalletStorage, Wallet
from electrum_xvg_gui.kivy.i18n import _
from electrum_xvg.paymentrequest import InvoiceStore
from electrum_xvg.util import profiler, InvalidPassword
from electrum_xvg.plugins import run_hook
from electrum_xvg.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_xvg_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_xvg_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_xvg_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_xvg_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_xvg_gui.kivy.uix.screens')
...
from electrum_xvg.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_xvg.network import DEFAULT_PORTS
    ...
    def on_qr(self, data):
        from electrum_xvg.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_xvg.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_xvg_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_xvg_gui.kivy.uix.qrcodewidget')
